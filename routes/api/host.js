...
//perform MySQL insert
    sqlQuery = `INSERT INTO host_tb(Stu_ID, Stu_LN, Stu_FN, Stu_Program, Stu_Birthdate, Stu_TIPEMAIL, Password)
...
// PATCH
// @routes UPDATE api/host/update/:id
// @desc CHANGES data from the database

router.patch('/update/:id',(req, res) => {
    console.log('API CONNECTION SUCCESS!');
    const id = req.params.id;
    dbConn.query(`SELECT Stu_ID FROM host_tb WHERE Stu_ID = ${id}`, function(error, results, fields){
        if(error) throw error;
            ...
            var Stu_TIPemail = req.body.Stu_TIPEMAIL
            var password = req.body.Password
            dbConn.query(`UPDATE host_tb SET Stu_ID = ${Stu_id}, Stu_LN = '${Stu_ln}', Stu_FN = '${Stu_fn}', Stu_Program = '${Stu_program}', 
...
// DELETE
// @routes DELETE api/host/delete
// @desc DELETES data from the database

router.delete('/delete/:Stu_ID', (req,res) => {
    console.log('API Running');
    const Stu_ID = req.params.Stu_ID;
    dbConn.query(`SELECT Stu_ID from host_tb WHERE Stu_ID = ${Stu_ID}`, function(error, results, fields){
        if (error) throw error;
            ...
            dbConn.query(`DELETE from host_tb WHERE Stu_ID = ${Stu_ID}`, function(error,results, fields){
